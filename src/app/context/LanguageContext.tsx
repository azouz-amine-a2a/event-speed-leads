...
const translations = {
  en: {
    ...
    'overview.totalWorkers': 'Total Staff Members',
    'overview.activeWorkers': 'Active Staff',
    'overview.avgLeads': 'Average Leads per Staff Member',
    'overview.avgPerWorker': 'Avg. per Staff Member',
    ...
    // Workers Management
    'workers.title': 'Staff Management',
    'workers.subtitle': 'Manage your staff members and their access',
    'workers.addWorker': 'Add Staff Member',
    'workers.name': 'Name',
    'workers.email': 'Email',
    ...
    'workers.disabled': 'Inactive',
    'workers.edit': 'Edit',
    'workers.disable': 'Disable',
    'workers.enable': 'Enable',
    'workers.deleteAction': 'Delete',
    'workers.deleteWorker': 'Delete Staff Member',
    'workers.deleteWarning': 'This action cannot be undone',
    'workers.deleteMessage': 'Are you sure you want to delete',
    'workers.confirmDelete': 'Delete Staff Member',
    'workers.noWorkers': 'No staff members yet',
    'workers.addWorkerTitle': 'Add Staff Member',
    'workers.editWorkerTitle': 'Edit Staff Member',
    'workers.password': 'Password',
    'workers.confirmPassword': 'Confirm Password',
    'workers.createWorker': 'Create Staff Member',
    'workers.updateWorker': 'Update Staff Member',
    'workers.cancel': 'Cancel',
    'workers.totalWorkers': 'Total Staff Members',
    'workers.activeWorkers': 'Active Staff',
    'workers.disabledWorkers': 'Inactive Staff',
    'workers.fullName': 'Full Name',
    'workers.emailHelp': 'Leave blank to allow login with name only',
    'workers.errorLoading': 'Failed to load staff members',
    'workers.workerAdded': 'Staff member added successfully!',
    'workers.errorAdding': 'Failed to add staff member',
    'workers.workerDisabled': 'Staff member disabled',
    'workers.workerEnabled': 'Staff member enabled',
    'workers.errorUpdating': 'Failed to update staff member status',
    'workers.workerUpdated': 'Staff member updated successfully!',
    'workers.workerDeleted': 'Staff member deleted successfully!',
    'workers.errorDeleting': 'Failed to delete staff member',
    'workers.editWorker': 'Edit Staff Member',
    ...
    'analytics.subtitle': 'Performance metrics and staff statistics',
    ...
    'analytics.disabled': 'Inactive',
    'analytics.leadsCollected': 'leads',
    'analytics.noWorkers': 'No staff members yet. Add staff to see performance.',
    'analytics.leadsPerWorker': 'Leads per Staff Member',
    'analytics.activeOnly': 'Active staff only',
    'analytics.leaderboard': 'Staff Leaderboard',
    'analytics.topPerformer': 'Top Performer',
    'analytics.totalActiveWorkers': 'Total Active Staff',
    'analytics.averagePerformance': 'Average Performance',
    'analytics.currentlyActive': 'Currently active',
    'analytics.leadsPerWorkerMetric': 'Leads per staff member',
    'analytics.noActiveWorkers': 'No active staff yet',
  ...
  fr: {
    ...
    'workers.addWorker': 'Ajouter un Employé',
    'workers.name': 'Nom',
    'workers.email': 'Email',
    ...
    'workers.disabledWorkers': 'Employés Inactifs',
    ...
    'workers.editWorker': 'Modifier l\'Employé',
